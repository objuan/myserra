...
#define esp8266_reset_pin 6 // Connect this pin to CH_PD on the esp8266, not reset. (let reset be unconnected)
...
void setup() {
  ...
  //wifi.startLocalAPAndServer("IGARDEN", "alicepi1", "12", "80");
  wifi.startLocalAPAndServer("VIOFILIALI", "alicepi1", "11", "80");
  //wifi.startLocalAP("IGARDEN", "alicepi1", "2");
